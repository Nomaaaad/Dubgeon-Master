...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    private bool ProcessRoomsInOpenRoomNodeQueue(RoomNodeGraphSO roomNodeGraph, Queue<RoomNodeSO> openRoomNodeQueue, bool noRoomOverlaps)
    {
        while (openRoomNodeQueue.Count > 0 && noRoomOverlaps == true)
        {
            ...
            // if the room type isn't an entrance
            else
            {
    ...
    private Doorway GetOppositeDoorway(Doorway doorwayParent, List<Doorway> doorwayList)
    {
        ...
        {
            if (doorwayParent.orientation == Orientation.east && doorwayParent.orientation == Orientation.west)
                return doorwayToCheck;

            else if (doorwayParent.orientation == Orientation.west && doorwayParent.orientation == Orientation.east)
                return doorwayToCheck;

            else if (doorwayParent.orientation == Orientation.north && doorwayParent.orientation == Orientation.south)
                return doorwayToCheck;

            else if (doorwayParent.orientation == Orientation.south && doorwayParent.orientation == Orientation.north)
                return doorwayToCheck;
